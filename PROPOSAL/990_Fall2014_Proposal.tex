...
% All these values are the same now, tonight I will change them to trace a rectangle with a lot of noise/pausing in between so that the application in Section 2 actually makes sense
